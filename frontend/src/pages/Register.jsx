      ...
      <div className="container max-w-lg">
        ...
        >
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold mb-3" style={{ fontFamily: 'var(--font-display)', fontSize: '2.25rem', fontWeight: 800, marginBottom: '0.75rem' }}>Join LuxeStore</h1>
            <p className="text-text-secondary" style={{ color: 'var(--color-text-secondary)' }}>Create an account for exclusive benefits.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <div className="input-group">
              ...
              <div className="relative">
                <FiUser className="absolute left-4 top-1/2 -translate-y-1/2 text-text-muted" style={{ position: 'absolute', left: '1rem', top: '50%', transform: 'translateY(-50%)', color: 'var(--color-text-muted)' }} />
                <input 
                  id="name"
                  type="text" 
                  required
          ...
          <div className="text-center mt-10" style={{ marginTop: '2.5rem', textAlign: 'center' }}>
            <p className="text-text-secondary" style={{ color: 'var(--color-text-secondary)' }}>
              ...
              <Link to="/login" className="text-primary font-bold hover:underline" style={{ color: 'var(--color-primary)', fontWeight: 700 }}>Sign In</Link>
            </p>
          </div>
        </motion.div>
      </div>
